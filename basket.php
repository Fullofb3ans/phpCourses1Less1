...
<?php
$firstBookPrice = 1000;
$secondBookPrice = 2000;
// 1
$summa = $firstBookPrice + $secondBookPrice;
echo '$summa=', $summa, '<br>';
// 2
$counter = 0;
$counter +=1;
...
$address = 'Saratov';
echo "$firstName" . "$lastName" . "$email" . "$address", '<br>';
// 5
// NULL, 'автор", 'Название', 123, 'описание', 'категория'
$null = Null;
$author = 'автор';
$title = 'Название';
$price = 123;
...
// 7
$plusNumber = '121';
echo ($plusNumber % 10 < 5) &&( $plusNumber % 100 > 20) ? 'true' : 'false', '<br>';
// 8
$oneInEnd = 11;
echo ($oneInEnd % 10) == 1 ? 'true' : 'false', '<br>';
?>
</div>
